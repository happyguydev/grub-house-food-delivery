          ...
          <View
            ...
            >
              <Icon
                ...
                size={24}
                Component={TouchableOpacity}
                onPress={() =>{console.log("asdfasdf"); this.RBSheet.close()}}
              />
            </TouchableOpacity>
              ...
              <View style={{flexDirection: "row", justifyContent: "space-between", alignItems: "center", width: "100%"}}>
                ...
                <View style={{width: "45%"}}>
                  <Dropdown
                    ...
                    onChangeText={(ev, index)=>{this.setState({selectedIndex: index}); console.log(ev, index)}}
                  />
                </View>
              </View> 
        ...
        >
          <View style={{ height: "100%", width: "80%", alignSelf: "center", paddingVertical: 10, justifyContent: "flex-end"}}>
            ...
            <Button
              ...
              onPress={() =>{this.confirmSheet.close(); 
        ...
        >
          <View style={{ height: "100%", width: "80%", alignSelf: "center", paddingVertical: 10, justifyContent: "flex-end"}}>
            ...
            <Button
              ...
              titleStyle={{color: global.COLOR.PRIMARY}}
              containerStyle={{marginBottom: 15, borderColor: global.COLOR.PRIMARY, borderWidth: 1}}
              onPress={() =>{this.confirmCheckSheet.close(); 
