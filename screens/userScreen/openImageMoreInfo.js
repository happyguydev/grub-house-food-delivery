...
export default class openImageMoreInfo extends Component {
      ...
      <ScrollView style={styles.bgContainer}>
        ...
        >
          ...
          style={{
            ...
            <TouchableOpacity>
              <Avatar
                ...
                rounded
                onPress= {()=>{
                  if(this.props.navigation.state.params.data.user[0].client_id == global.USER.details.client_info.client_id){
          ...
          </View>
          {
            ...
            this.props.navigation.state.params.data.user[0].client_id == global.USER.details.client_info.client_id?<View
